    ...
    if completion_contract:
        ...
        note += (
            ...
            + " The identity/scope fields (task_id, assignment_id, execution_id, "
              ...
              "Planning and scope approval are complete for this Switchboard "
              "execution. The task contract and acceptance criteria are the "
              "approved implementation plan. Do not invoke or repeat brainstorming "
              "or writing-plans, design approval, or routine scope approval "
              "workflows. Do not ask whether to proceed or request routine "
              "implementation approval. Execute the assigned role autonomously "
              "using systematic debugging, test-driven development, review, and "
              "verification where applicable. If a genuine human-authority "
              "exception blocks progress, use the typed agent_requires_human tool "
              "with the concrete missing decision or permission. Assistant prose "
              "is not an authority request.\n"
