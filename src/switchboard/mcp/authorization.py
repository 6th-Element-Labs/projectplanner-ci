...
READ_TOOLS = frozenset({
    ...
    "get_preflight_calibration", "get_preflight_run", "get_reason_code_counts",
...
WRITE_TOOLS = frozenset({
    ...
    "attach_provider_connection_to_project", "begin_agent_host_enrollment",
    ...
    "create_scm_connection", "create_task", "create_work_session",
    "defer_deliverable_breakdown",
    "delete_provider_connection", "delete_scm_connection",
    "enroll_provider_connection", "execute_project_purge",
    ...
    "remove_dependency", "repo_preflight", "report_usage", "reserve_spend",
    "reconcile_spend", "set_spend_envelope", "request_external_ci_mirror_run",
    "request_unblock", "resolve_monitor", "resolve_review_finding",
    "restore_project", "retry_task", "report_stale_assignment",
    "revoke_claim", "revoke_provider_connection",
    "revoke_scm_connection",
    ...
    "update_deliverable", "update_mission_narrative", "update_project",
    "update_scm_connection", "update_task",
    "update_work_session",
    "update_agent_host_execution_policy",
    "verify_ci", "verify_external_effect",
