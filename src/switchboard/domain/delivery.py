...
Mailbox persistence, runtime presence, and Agent Host wakeability are separate
facts.  This module turns those facts into one stable operator-facing receipt
without depending on SQLite, HTTP, or MCP adapters.
"""
...
def build_message_delivery_receipt(
        ...
        acked_at: Optional[float] = None) -> Dict[str, Any]:
