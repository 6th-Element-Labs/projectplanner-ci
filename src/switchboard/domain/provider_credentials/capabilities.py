...
_CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    {
        "capability_id": "opencode-zen-host-bound-native-cli",
        "provider": "opencode-zen",
        "auth_mode": "opencode_zen_login",
        "auth_type_aliases": (
            "browser_login", "host_login", "local_login_session",
            "oauth_personal", "zen_host_login", "zen_login",
        ),
        "host_class": "user_owned_persistent",
        "portability": "host_bound",
        "bootstrap_method": "opencode_auth_login_on_host",
        "concurrency": {"mode": "exclusive", "max_parallel": 1},
        "state": "supported_host_bound",
        "approval_state": "official_local_cli_auth_documented",
        "disable_reason": "",
    ...
    {
        "capability_id": "opencode-zen-auth-json-portable-worker",
        "provider": "opencode-zen",
        "auth_mode": "opencode_zen_login",
        "auth_type_aliases": (
            "auth_json_export", "personal_subscription", "session_capsule",
            "subscription",
        ),
        "host_class": "managed_or_ephemeral_worker",
        "portability": "unsupported",
        ...
        "state": "unavailable",
        "approval_state": "supported_portable_bootstrap_not_documented",
        "disable_reason": "opencode_zen_login_portability_unavailable",
        "execution_path": "disabled",
        "litellm": {"eligible": False, "reason": "personal_subscription_not_api_auth"},
        "evidence": _evidence(
            "https://opencode.ai/docs/zen/",
    ...
    {
        "capability_id": "opencode-zen-api-key-worker",
        "provider": "opencode-zen",
        "auth_mode": "api_key",
        "auth_type_aliases": (
            "api_key", "customer_api_key", "customer_metered_api", "metered_api",
        ...
        "host_class": "managed_or_user_owned_worker",
        "portability": "portable_secret",
        "bootstrap_method": "opencode_zen_api_key",
        "concurrency": {"mode": "bounded", "max_parallel": "provider_and_budget_policy"},
        "state": "supported",
        "approval_state": "official_automation_auth_documented",
        "disable_reason": "",
        "execution_path": "native_cli",
        "litellm": {"eligible": False, "reason": "opencode_zen_is_already_the_gateway"},
        "evidence": _evidence(
            "https://opencode.ai/docs/zen/",
            "https://opencode.ai/docs/cli/",
        ),
