...
| **ARCH-MS-23** | Global auth cutover — remove `PM_GLOBAL_AUTH` gate | 0.3 | 18 | In Progress | 🔗 | **ACCESS-16** / PR #300 deleted the legacy login + flag; ARCH-MS-23 adds a CI regression guard against their return |
