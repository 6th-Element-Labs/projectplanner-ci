...
observation remains authoritative. The repair passed the focused regression and
normalization-law suite before publication, then passed the ordinary trusted full
gate at exact head `bc477274225bf9073d90b64695d82f51744f70de`. The initial
affected canaries were not manually advanced or retried.
