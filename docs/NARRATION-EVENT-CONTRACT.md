# Narration event contract and delivery semantics

- **Status:** Normative implemented protocol contract; demoted from the active ADR set
  by the 2026-07-31 decision-corpus consolidation
- **Date:** 2026-07-11
- **Canonical reference:** `switchboard.narration_requested.v1`
