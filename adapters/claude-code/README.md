...
# agent-set Done is denied even through complete_claim:
echo '{"tool_name":"mcp__taikun-plan__complete_claim","tool_input":{"claim_id":"taskclaim-123","final_status":"Done","evidence":"{\"branch\":\"claude/TASK-1\",\"head_sha\":\"abc\"}"}}' \
  | python3 adapters/claude-code/pretooluse_guard.py        # -> permissionDecision: deny

# normal claim completion is allowed and moves the task to In Review:
echo '{"tool_name":"mcp__taikun-plan__complete_claim","tool_input":{"claim_id":"taskclaim-123","evidence":"{\"branch\":\"claude/TASK-1\",\"head_sha\":\"abc\"}"}}' \
