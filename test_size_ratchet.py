...
LINE_CEILINGS = {
    ...
    "app.py": 3_321,  # DELIVERABLES-17: closure_request verifier-dispatch REST route (+16)
    "mcp_server.py": 3_215,  # DELIVERABLES-17: request_deliverable_closure_verification tool (+25)
