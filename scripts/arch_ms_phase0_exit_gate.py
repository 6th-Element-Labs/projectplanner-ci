...
REQUIRED_ARTIFACTS = (
    ...
    "src/switchboard/storage/repositories/coordination.py",
    "src/switchboard/storage/repositories/deliverables.py",
    "src/switchboard/storage/repositories/provenance.py",
    "src/switchboard/storage/repositories/runner.py",
    "src/switchboard/storage/repositories/tasks.py",
    "auth_store.py",
    "claims_store.py",
    "coordination_store.py",
    "deliverables_store.py",
    "provenance_store.py",
    "runner_store.py",
    "tasks_store.py",
    "tests/path_setup.py",
    ...
    "tests/test_arch_ms33_coordination_repository.py",
    "tests/test_arch_ms34_provenance_repository.py",
    "tests/test_arch_ms35_deliverables_repository.py",
