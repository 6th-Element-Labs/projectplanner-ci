"""Numbered, ledgered additive schema migrations (BUG-47 / ADR-0007 Decision 7).
...
Per ADR-0007 Decision 7 the eventual home for this is ``storage/migrations/``; the logic
lives in the existing ``db/`` layer today alongside db/schema.py rather than standing up a
second, empty package tree.
"""
import sqlite3
import time
